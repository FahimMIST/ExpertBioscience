...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    en: {
      ...
      benefits: [
        ...
        'Provides a quick resolution for Black Gill, Brown Gill, and gulping (Gulping) issues.',
    ...
    bn: {
      ...
      benefits: [
        ...
        'পানিতে সৃষ্ট ব্ল্যাক গিল (Black Gill), ব্রাউন গিল (Brown Gill) এবং খাবি খাওয়া (Gulping) সমস্যা হতে দ্রুত সমাধান করে।',
  ...
  },
  {
    ...
    bn: {
      title: 'Bioprob Max - বায়োপ্রোব ম্যাক্স',
  ...
  },
  {
    ...
    en: {
      title: 'Farmizyme',
      category: 'Digestive Enzyme & Gut Probiotic',
    ...
    bn: {
      ...
      category: 'হজমকারক ও গাট প্রোবায়োটিক',
  ...
  },
  {
    ...
    en: {
      ...
      category: 'Immune Booster & Vitamin C',
    ...
    bn: {
      title: 'Biomin C Complex - বায়োমিন সি কমপ্লেক্স',
      category: 'রোগ প্রতিরোধক ও ভিটামিন সি',
  ...
  },
  {
    ...
    bn: {
      title: 'Bioliv Care - বায়োলিভ কেয়ার',
  ...
  },
  {
    ...
    bn: {
      title: 'Pure Saline - পিউর স্যালাইন',
      category: 'গ্লুকোজ ও মিনারেল মিক্সার',
  ...
  },
  {
    ...
    bn: {
      title: 'Yucca Biosol - ইউকা বায়োসল',
  ...
  },
  {
    ...
    bn: {
      title: 'Zeoprob Plus - জিওপ্রোব প্লাস',
      category: 'জিওলাইট ও পুকুর কন্ডিশনার',
  ...
  },
  {
    ...
    bn: {
      title: 'Deltam - ডেল্টাম',
      category: 'সিন্থেটিক পরজীবীনাশক',
  ...
  },
  {
    ...
    bn: {
      title: 'Killer Phos - কিলার ফস',
      category: 'শক্তিশালী কীটনাশক',
